...
public class MemberHandler {
  ...
  void onList() {
    ...
    for (Member member : list) {
      ...
      System.out.printf("%d\t%s\t%s\n",
          member.no, member.title, member.email, dateStr);
    }
  ...
  void onInput() {
    ...
    member.title = Prompt.inputString("이름? ");
  ...
  void onUpdate() {
    ...
    String newTitle = Prompt.inputString("이름?(" + member.title + ") ");
    String newContent = Prompt.inputString(String.format("이메일?(%s) ", member.email));
